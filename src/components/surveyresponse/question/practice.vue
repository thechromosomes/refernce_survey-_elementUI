            ...
            <div class="practicefield" v-if="isnewwebsite" >
                <template v-if="practicedata.website.length > 0" >
                    <v-layout :key="index" v-for="(item, index) in practicedata.website">
                        ...
                        <v-flex xs3 >
                            <v-btn depressed class="icon30 edit " v-if="index == (practicedata.website.length-1)" fab @click="addnewwebsite" >
                                <v-icon>add</v-icon>
                            </v-btn>
...
export default {
    ...
    watch: {
        ...
        practice: function (newjumptoquestion, oldjumptoquestion) {
            this.mapalldata()
        },    
    },    
    created() {
