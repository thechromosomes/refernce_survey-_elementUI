<template>
  <div class="thankyoupage qtype">
    <div class="editorinput-conatiner"> 
      <div class="editorinput-title">Thankyou Note: </div>
        <tinymce :id="`editor_${qtypedata._id}`" ref="tincyeditor" v-model="qtypedata.description" @input="changeDescription" editorInit="ddfgnm,dnfgmndf" @editorInit="editorInit"></tinymce>
