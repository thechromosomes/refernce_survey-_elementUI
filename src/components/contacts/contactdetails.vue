...
<v-container>
 <div class="addemailform">
     <v-flex xs12 v-if="contactdetails != null"><h2> Contacts Name: {{contactdetails.listname}}</h2></v-flex>
     <br/>
      <v-layout row wrap>
      <v-flex xs12><h2>Add user to list</h2></v-flex>
      </v-layout>
        <v-layout>
            <v-flex xs12> 
                  <v-text-field prepend-icon="person" v-model="firstname" label="Firstname" type="text"></v-text-field>
            </v-flex>
       </v-layout>
       <v-layout>
            <v-flex xs12> 
                  <v-text-field prepend-icon="person" v-model="lastname" label="Lastname" type="text"></v-text-field>
            </v-flex>
       </v-layout>
       <v-layout>
            <v-flex xs12> 
        ...
        <v-layout>
          <v-btn @click='addemailform'>Add</v-btn>
          <v-btn @click='gotolist'>Cancel</v-btn>
          </v-layout>
  </div>
 <v-layout row wrap>
 <v-flex xs12><h2> Contacts Members</h2></v-flex>
 </v-layout>
    <v-layout>
          <v-container>
            <v-card> 
